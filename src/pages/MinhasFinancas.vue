      ...
      <q-card class="container-card q-pa-lg">
        <q-card-section class="main-section q-gutter-md">
          ...
          <q-card bordered class="main-card q-pa-lg">
            <q-card-section>
              <q-item-label><strong>Saldo atual</strong></q-item-label>
          ...
          <q-card bordered class="main-card q-pa-lg">
            <q-card-section>
              <q-item-label><strong>Entradas</strong></q-item-label>
              <q-item-label>R$ 15,00</q-item-label>
            </q-card-section>
          </q-card>
          ...
          <q-card bordered class="main-card q-pa-lg">
            <q-card-section>
              <q-item-label><strong>Saídas</strong></q-item-label>
              <q-item-label>R$ 35,00</q-item-label>
            </q-card-section>
          </q-card>
        </q-card-section>
        ...
        <q-card-section class="btn-card q-gutter-md">
          <q-btn
            v-on:click="adicionarMovimentacao()"
            unelevated
            size="md"
